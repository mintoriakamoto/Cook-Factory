...
4. Delegates to `/ferrox plan-phase <N>` which auto-detects MVP mode via the roadmap field
...
<process>
Execute the mvp-phase workflow from @~/.claude/ferrox-core/workflows/mvp-phase.md end-to-end.
