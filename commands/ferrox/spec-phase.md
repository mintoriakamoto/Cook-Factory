...
<execution_context>
@~/.claude/ferrox-core/workflows/spec-phase.md
@~/.claude/ferrox-core/templates/spec.md
</execution_context>
...
- User knows they can now run /ferrox:discuss-phase which will load SPEC.md automatically
</success_criteria>
