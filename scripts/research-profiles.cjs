 ...
 *   requiredIncludes — @~/.claude/ferrox-core/references/<file>.md strings the body MUST contain
 *   requiredSeamCalls — `ferrox_run query <cmd>` strings the body MUST contain
 *   outputContract   — strings the body MUST contain (output path, return marker, etc.)
 */

const PROFILES = [
  {
    name: 'ferrox-project-researcher',
    description:
      'Researches domain ecosystem before roadmap creation. Produces files in .planning/research/ consumed during roadmap creation. Spawned by /ferrox:new-project or /ferrox:new-milestone orchestrators.',
    color: 'cyan',
    tools:
    ...
    requiredSeamCalls: [
      'ferrox_run query research-plan',
      'ferrox_run query research-store put',
      'ferrox_run query classify-confidence',
    ],
    outputContract: [
      '.planning/research/',
      '## RESEARCH COMPLETE',
  ...
  },
  {
    ...
    description:
      'Researches how to implement a phase before planning. Produces RESEARCH.md consumed by ferrox-planner. Spawned by /ferrox:plan-phase orchestrator.',
    color: 'cyan',
    tools:
    ...
    requiredSeamCalls: [
      ...
      'ferrox_run query research-store put',
      'ferrox_run query classify-confidence',
      'ferrox_run query package-legitimacy check',
    ],
    outputContract: [
  ...
  {
    name: 'ferrox-advisor-researcher',
    description:
  ...
  {
    name: 'ferrox-ui-researcher',
    description:
      'Produces UI-SPEC.md design contract for frontend phases. Reads upstream artifacts, detects design system state, asks only unanswered questions. Spawned by /ferrox:ui-phase orchestrator.',
    color: 'purple',
    tools:
  ...
  {
    name: 'ferrox-research-synthesizer',
    description:
      'Synthesizes research outputs from parallel researcher agents into SUMMARY.md. Spawned by /ferrox:new-project after 4 researcher agents complete.',
    color: 'purple',
