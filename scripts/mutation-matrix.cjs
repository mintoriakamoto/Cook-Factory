 ...
 *     "matrix": {
 *       "include": [
 *         { "name": "<module>", "mutate": "ferrox-core/bin/lib/<module>.cjs", "tests": "<space-joined test files>" },
 *         ...
 *       ]
 *     }
 *   }
...
const COVERED = {
  'context-utilization': {
    cjs: 'ferrox-core/bin/lib/context-utilization.cjs',
    tests: [
  ...
  'prompt-budget': {
    cjs: 'ferrox-core/bin/lib/prompt-budget.cjs',
    tests: [
  ...
  frontmatter: {
    cjs: 'ferrox-core/bin/lib/frontmatter.cjs',
    tests: [
  ...
  'adr-parser': {
    cjs: 'ferrox-core/bin/lib/adr-parser.cjs',
    tests: [
  ...
  'config-schema': {
    cjs: 'ferrox-core/bin/lib/config-schema.cjs',
    tests: [
  ...
  'active-workstream-store': {
    cjs: 'ferrox-core/bin/lib/active-workstream-store.cjs',
    tests: [
  ...
  'core-utils': {
    cjs: 'ferrox-core/bin/lib/core-utils.cjs',
    tests: [
