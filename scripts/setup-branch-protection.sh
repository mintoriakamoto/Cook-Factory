...
#
# Apply branch protection rules to `main` and `next` for the Ferrox repo.
...
#
# Requirements:
#   - gh CLI authenticated against ferroxfactory/ferrox-core with admin scope
#   - jq installed
#
# What it sets:
#
...
REPO="${REPO:-ferroxfactory/ferrox-core}"
DRY_RUN="${DRY_RUN:-0}"
