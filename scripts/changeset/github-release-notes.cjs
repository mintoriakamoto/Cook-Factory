...
const { packageName, repoSlug: defaultRepoSlug } = require('../../ferrox-core/bin/lib/package-identity.cjs');
...
const FIXED_GROUPS = [
  ...
  },
  {
    ...
    pattern: /\b(install|installer|runtime|windows|powershell|codex|gemini|antigravity|hook|hooks|ferrox-sdk|sdk readiness|cjs|model-catalog|path|shim)\b/i,
  },
];
...
const REMOVED_GROUPS = [
  {
    title: 'Intel updater',
    pattern: /\b(intel|ferrox-intel-updater|layout detection)\b/i,
  },
];
