 ...
 *               assertion.
 *
 * Seed: agent-skills (P2/P3 fix, #1415/#1416) was the founding member; its
 * registration was removed when the upstream tests/agent-skills.test.cjs was
 * dropped in the GSD->Ferrox fork cleanup (the guard's own remedy for an
 * unreadable test file). Re-register it when provenance tests for the
 * agent_skills resolution in src/init.cts land.
 */
const REGISTRY = [];
