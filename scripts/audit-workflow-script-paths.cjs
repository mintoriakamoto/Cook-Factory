 ...
 *
 * Walks workflowsDir, extracts every `${FERROX_HOME[...]}/<path>.<cjs|js|sh>`
 * token, and asserts:
...
// Match `${FERROX_HOME}` or `${FERROX_HOME:-...}` followed by a /-rooted path
// ending in .cjs/.js/.sh. The path is captured verbatim (relative to
// the install root).
const REF_RE = /\$\{FERROX_HOME(?::-[^}]*)?\}\/([A-Za-z0-9_./-]+\.(?:cjs|js|sh))/g;
