...
<objective>
Analyze existing codebase using parallel ferrox-codebase-mapper agents to produce structured codebase documents.
...
<execution_context>
@~/.claude/ferrox-core/workflows/map-codebase.md
</execution_context>
...
- Via /ferrox-onboard for first-time brownfield setup - creates codebase map first
- After /ferrox-new-project (greenfield codebases) - updates codebase map as code evolves
...
3. Spawn 4 parallel ferrox-codebase-mapper agents:
...
7. Offer next steps (typically: /ferrox-onboard, /ferrox-new-project, or /ferrox-plan-phase)
</process>
