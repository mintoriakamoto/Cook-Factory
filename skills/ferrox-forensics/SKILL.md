...
<objective>
Investigate what went wrong during a Ferrox workflow execution. Analyzes git history, `.planning/` artifacts, and file system state to detect anomalies and generate a structured diagnostic report.
...
<execution_context>
@~/.claude/ferrox-core/workflows/forensics.md
</execution_context>
