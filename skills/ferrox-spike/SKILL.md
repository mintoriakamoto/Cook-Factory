---
name: ferrox-spike
description: "You want to find out whether something will work at all. Throwaway experiment, not a build"
...
Spikes live in `.planning/spikes/` and integrate with Ferrox commit patterns, state tracking,
...
<execution_context>
@~/.claude/ferrox-core/workflows/spike.md
@~/.claude/ferrox-core/workflows/spike-wrap-up.md
