---
name: ferrox-debug
description: "Something is broken, failing, crashing or behaving wrong. Investigates and survives /clear"
...
**Orchestrator role:** Gather symptoms, spawn ferrox-debugger agent, handle checkpoints, spawn continuations.
...
<execution_context>
@~/.claude/ferrox-core/workflows/debug.md
</execution_context>
