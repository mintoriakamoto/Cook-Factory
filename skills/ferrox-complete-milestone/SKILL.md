...
- @~/.claude/ferrox-core/templates/milestone-archive.md (archive template)
  </execution_context>
...
0. **Check for audit:**
   ...
   - If audit status is `gaps_found`: recommend closing the gaps inline
     ...
     via `/ferrox-phase --insert <N>` plus the standard
...
- **Fresh requirements:** Next milestone starts with `/ferrox-new-milestone` which includes requirements definition
  </critical_rules>
