...
<objective>
Capture ideas, tasks, notes, and seeds to their appropriate destination in the Ferrox system.
...
<execution_context>
@~/.claude/ferrox-core/workflows/add-todo.md
@~/.claude/ferrox-core/workflows/note.md
@~/.claude/ferrox-core/workflows/add-backlog.md
@~/.claude/ferrox-core/workflows/plant-seed.md
@~/.claude/ferrox-core/workflows/check-todos.md
@~/.claude/ferrox-core/workflows/list-seeds.md
