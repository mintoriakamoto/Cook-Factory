...
│   └── ferrox/           # Ferrox-specific commands
├── ferrox-core/     # Skill resources
...
**New Slash Command:**
- Primary code: `commands/ferrox/{command-name}.md`
- Tests: `tests/commands/{command-name}.test.js` (if testing implemented)
- Documentation: Update `README.md` with new command

**New Template:**
- Implementation: `ferrox-core/templates/{name}.md`
- Documentation: Template is self-documenting (includes guidelines)

**New Workflow:**
- Implementation: `ferrox-core/workflows/{name}.md`
- Usage: Reference from command with `@~/.claude/ferrox-core/workflows/{name}.md`

**New Reference Document:**
- Implementation: `ferrox-core/references/{name}.md`
