...
- This section feeds directly into /ferrox:plan-phase --gaps
...
5. status → "diagnosed"
6. Ready for /ferrox:plan-phase --gaps with root causes
...
**Creation:** When /ferrox:verify-work starts new session
...
- `/ferrox:verify-work {phase}` picks up from first pending/blocked test
