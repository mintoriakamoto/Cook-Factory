...
Template for spawning ferrox-debugger agent. The agent contains all debugging expertise - this template provides problem context only.
...
```python
Task(prompt=template, subagent_type="ferrox-debugger", description="Debug UAT-001")
```
