...
For deep ecosystem research ("how do experts build this"), use `/ferrox:plan-phase --research-phase` which produces RESEARCH.md.
...
- Use `/ferrox:plan-phase --research-phase` for these
</guidelines>
