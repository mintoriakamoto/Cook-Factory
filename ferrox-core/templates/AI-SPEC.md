...
> AI design contract generated by `/ferrox:ai-integration-phase`. Consumed by `ferrox-planner` and `ferrox-eval-auditor`.
...
> Researched by `ferrox-domain-researcher`. Grounds the evaluation strategy in domain expert knowledge.
...
> Fetched from official docs by `ferrox-ai-researcher`. Distilled for this specific use case.
...
> Written by `ferrox-ai-researcher`. Cross-cutting patterns every developer building AI systems needs — independent of framework choice.
