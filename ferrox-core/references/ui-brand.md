...
Visual patterns for user-facing Ferrox output. Orchestrators @-reference this file.
...
**Also available:**
- `/ferrox-alternative-1` — description
- `/ferrox-alternative-2` — description
...
- Skipping `Ferrox ►` prefix in banners
- Random emoji (`🚀`, `✨`, `💫`)
