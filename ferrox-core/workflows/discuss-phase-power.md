...
<trigger>
This workflow executes when `--power` flag is present in ARGUMENTS to `/ferrox:discuss-phase`.
...
Consider running /ferrox:discuss-phase {N} again to refine before planning.
```
