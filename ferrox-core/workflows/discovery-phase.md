...
NOTE: For comprehensive ecosystem research ("how do experts build this"), use /ferrox:plan-phase --research-phase instead, which produces RESEARCH.md.
</purpose>
...
See ~/.claude/ferrox-core/templates/discovery.md `<discovery_protocol>` for full protocol.
</source_hierarchy>
...
6. **Create DISCOVERY.md** using ~/.claude/ferrox-core/templates/discovery.md structure:
...
1. **Scope the discovery** using ~/.claude/ferrox-core/templates/discovery.md:
...
6. **Create comprehensive DISCOVERY.md:**
   ...
   - Full structure from ~/.claude/ferrox-core/templates/discovery.md
...
Use ~/.claude/ferrox-core/templates/discovery.md.
...
1. Discuss phase context (/ferrox:discuss-phase [current-phase])
2. Create phase plan (/ferrox:plan-phase [current-phase])
