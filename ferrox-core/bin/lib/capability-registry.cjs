...
const capabilities = {
  ...
  "cline": {
    ...
    "runtime": {
      ...
      "hostBehaviors": {
        "reapplyCommand": "/ferrox-update --reapply",
  ...
  "cursor": {
    ...
    "runtime": {
      ...
      "hostBehaviors": {
        "reapplyCommand": "ferrox-update --reapply (mention the skill name)",
  ...
  "drift": {
    ...
    "config": {
      ...
      "workflow.drift_action": {
        ...
        "default": "warn",
        "description": "Action taken by the codebase drift gate when the threshold is exceeded: warn (advisory message) or auto-remap (spawn ferrox-codebase-mapper agent to refresh STRUCTURE.md)."
      },
  ...
  "external-job": {
    ...
    "config": {
      ...
      "external_job.artifact_dir": {
        ...
        "description": "Root for per-job artifact directories (e.g. Artifacts/jobs/<jobid>/). Avoids fixed log paths and hardcoding a cluster/project layout. Surfaced by the adapter (`slurm-adapter.cjs submit` prints the resolved value); override via FERROX_EXTERNAL_JOB_ARTIFACT_DIR."
      },
      "external_job.submit_timeout_ms": {
        "type": "number",
        "default": 30000,
        "description": "Hard timeout (ms) for the scheduler submit subprocess (e.g. sbatch). Bounded per CLAUDE.md unbounded-subprocess policy. Read by the adapter (env FERROX_SLURM_SUBMIT_TIMEOUT_MS overrides)."
      },
  ...
  "hermes": {
    ...
    "runtime": {
      ...
      "hostBehaviors": {
        ...
        "reapplyCommand": "ferrox-update --reapply (mention the skill name)",
        "legacyCommandsFerroxInstallMigration": true,
        "legacyCommandsFerroxUninstall": true,
        "hyphenNameAgentBody": true
      },
      "hostIntegration": {
        "embeddingMode": "imperative",
    ...
    "runtime": {
      ...
      "hostBehaviors": {
        ...
        "nativePlugin": {
          "dir": "plugins",
          "file": "ferrox-core.js",
          "source": ".kilo/plugins/ferrox-core.js"
        },
        "skipUpdateBannerCommand": true,
        "skipSharedHooksInstall": true
      }
  ...
  "kimi": {
    ...
    "runtime": {
      ...
      "hostBehaviors": {
        "reapplyCommand": "/skill:ferrox-update --reapply",
  ...
  "mempalace": {
    ...
    "config": {
      ...
      "mempalace.memory_mode": {
        ...
        "default": "augment",
        "description": "How MemPalace relates to Ferrox native memory during recall/capture. 'augment' (default): the palace is an additive layer alongside .planning/graphs/ — native memory stays authoritative. 'kg_backend': knowledge-graph queries resolve against the palace's temporal KG as the primary source, with .planning/graphs/ as fallback. 'replace': recall resolves through the palace as the source of truth, native memory as fallback. Every mode stays onError:skip and default-resilient — an unreachable palace degrades to native memory, and Ferrox keeps writing .planning/graphs/ so no memory is lost. Cross-mode migration of existing .planning/graphs/ into the palace is a separate, not-yet-implemented concern."
      },
      "mempalace.wing": {
        "type": "string",
        "default": "",
    ...
    "steps": [
      ...
      },
      {
        "point": "ship:post",
        "ref": {
          "agent": "ferrox-mempalace-curator"
        },
        "produces": [],
        "consumes": [
          "UAT.md"
    ...
    "runtime": {
      ...
      "hostBehaviors": {
        ...
        "nativePlugin": {
          "dir": "plugins",
          "file": "ferrox-core.js",
          "source": ".opencode/plugins/ferrox-core.js"
        },
  ...
  "wayland-core": {
    ...
    "runtime": {
      ...
      "hostBehaviors": {
        ...
        "ownsAgentLoop": true,
        "nodeCliRole": "skills-and-mcp-bridge"
      }
    }
  },
  "windsurf": {
...
const byAgent = {
  "ferrox-framework-selector": "ai-integration",
  "ferrox-ai-researcher": "ai-integration",
  "ferrox-domain-researcher": "ai-integration",
  "ferrox-eval-planner": "ai-integration",
  "ferrox-code-reviewer": "code-review",
  "ferrox-code-fixer": "code-review",
  "ferrox-mempalace-curator": "mempalace",
  "ferrox-nyquist-auditor": "nyquist",
  "ferrox-pattern-mapper": "pattern-mapper",
  "ferrox-user-profiler": "profile-pipeline",
  "ferrox-phase-researcher": "research",
  "ferrox-security-auditor": "security",
  "ferrox-ui-checker": "ui",
  "ferrox-ui-auditor": "ui",
  "ferrox-design-critic": "ui",
  "ferrox-a11y-design-reviewer": "ui",
  "ferrox-a11y-auditor": "ui"
};
