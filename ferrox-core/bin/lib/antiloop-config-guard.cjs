 ...
 */
const UNATTENDED_MODES = Object.freeze(['autonomous', 'yolo']);
...
function textMember(value, accepted) {
 ...
 */
function thresholdMember(value) {
 ...
 */
function autoAdvanceMember(value) {
 ...
 */
function evaluateLoopConfigCombination(input) {
    const source = input ?? {};
    const states = [
