/*!
 * js-yaml 4.2.0, vendored verbatim from the npm dist build (dist/js-yaml.js).
 * License: MIT, Copyright (C) 2011-2015 by Vitaly Puzrin. Full text in the
 * upstream LICENSE: https://github.com/nodeca/js-yaml/blob/master/LICENSE
 * Vendored so the installed ferrox-core tree runs with no node_modules:
 * sealed-store execution and the file-copy install must not depend on npm.
 */
