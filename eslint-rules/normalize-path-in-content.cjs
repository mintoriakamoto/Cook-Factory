 ...
 *       catches `${computePathPrefix(t)}/commands/ferrox/x.md` and
...
//     ferrox/x.md` and `@${getGlobalConfigDir('claude')}/commands/ferrox/help.md`
...
//   `/workflows`, `/rules`, `/ferrox`) — these are too broad as standalone
...
// end of the quasi string.  This matches `/commands/ferrox/x.md`,
  ...
  create(context) {
    return {
      ...
      TemplateLiteral(node) {
        ...
        // `${computePathPrefix(t)}/commands/ferrox/x.md` and
        // `@${getGlobalConfigDir('claude')}/commands/ferrox/help.md` without
