 ...
 * and file audit). Opt-in: set FERROX_AUDIT_ARGS=1 to include args verbatim.
 *
 ...
 * Only FERROX_AUDIT_ARGS === '1' enables inclusion; any other value (including
 * empty string, 'true', 'yes') keeps the default of omitting args.
 */
export function shouldIncludeArgs(): boolean {
  return process.env.FERROX_AUDIT_ARGS === '1';
}
 ...
 * If args should be included (FERROX_AUDIT_ARGS=1), passes the event through
