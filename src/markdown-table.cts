 ...
 * no I/O. Compiled by tsc to ferrox-core/bin/lib/markdown-table.cjs.
 *
...
/**
 * Canonical column-header shapes for every GFM table Ferrox parses or generates.
 ...
 *
 * Scope note: Ferrox planning tables (STATE.md/ROADMAP.md/requirements.md/
 ...
 * guard). Never touches disk, git, or the clock — callers (the `ferrox-tools
...
// Consumers: require('../ferrox-core/bin/lib/markdown-table.cjs')
