 ...
 * `ferrox-core/bin/lib/probe-core.cjs`. Do NOT hand-write the `.cjs`; it is emitted.
 *
...
export interface Prohibition {
  ...
  // subject's CONTENT, not merely by FERROX_PROHIB_SUBJECT being set. Projected only alongside a
