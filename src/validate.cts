 ...
 *   - Issue #6 (ferroxfactory/ferrox-core)
 *   - Issue #26 (ferroxfactory/ferrox-core)
...
// deep dirs (02-04-01-deep), and project-code-prefixed variants (Ferrox-02-01-setup).
...
// multi-segment tokens like "02-01" from "02-01-setup" or "Ferrox-02-01-setup".
...
export function buildRoadmapPhaseVariants(roadmapContent: string): RoadmapPhaseVariantsResult {
  ...
  // and bracket-prefixed (### [Ferrox] Phase 2-01:) headings.
