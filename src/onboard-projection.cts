...
function buildHandoffCommands(cwd: string): OnboardHandoffCommands {
  ...
  return {
    ingest_docs: formatFerroxSlash('ingest-docs', runtime) as string,
    manager: formatFerroxSlash('manager', runtime) as string,
    map_codebase: formatFerroxSlash('map-codebase', runtime) as string,
    map_codebase_fast: formatFerroxSlash('map-codebase --fast', runtime) as string,
    new_project: formatFerroxSlash('new-project', runtime) as string,
    onboard: formatFerroxSlash('onboard', runtime) as string,
  };
}
