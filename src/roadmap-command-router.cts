...
function checkW021(content: string): W021Warning[] {
  ...
  const MIGRATION_CMD = 'ferrox-tools roadmap upgrade --convention milestone-prefixed';

  // Milestone section heading: ## [Ferrox] v2.0 — Label  OR  ## v2.0: Label  OR  ## Roadmap v2.0
