...
//
//   1. Co-located install path — ferrox-core/bin/shared/model-catalog.json
//   2. Source-repo dev path — sdk/shared/model-catalog.json
//   3. FERROX_MODEL_CATALOG env override
const _catalogCandidates: string[] = [
  ...
  ...(process.env['FERROX_MODEL_CATALOG'] ? [path.resolve(process.env['FERROX_MODEL_CATALOG'])] : []),
];
