 ...
 * Moves coverage/infra/overall arithmetic out of the ferrox-eval-auditor prompt
...
function cmdEvalScore(_cwd: string, args: string[], raw: boolean): void {
  ...
  if (
    ...
    process.stderr.write('Usage: ferrox-tools query eval.score --covered N --total N --infra a,b,c,d,e (each ok|partial|missing)\n');
    process.exitCode = 1;
    return;
  }
