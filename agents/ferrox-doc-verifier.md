...
Spawned by the `/ferrox:docs-update` workflow. Each spawn receives a `<verify_assignment>` XML block containing:
...
- **Ferrox marker**: The comment `<!-- generated-by: ferrox-doc-writer -->` — skip entirely.
