...
// ferrox-cursor-subagent-stop.js — Cursor subagentStop hook (ADR-1239 / #2089)
//
...
process.stdin.on('end', () => {
  ...
  try {
    process.stdout.write(JSON.stringify({
      additional_context:
        'Ferrox: Subagent completed — review its output and update .planning/STATE.md if the phase progressed.',
    }));
  } catch {
    process.stdout.write(JSON.stringify({}));
  }
