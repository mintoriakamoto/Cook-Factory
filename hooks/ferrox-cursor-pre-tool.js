...
// ferrox-cursor-pre-tool.js — Cursor preToolUse hook (ADR-1239 / #2089)
//
  ...
  try {
    ...
    if (paths.some((p) => PLANNING_PATH_RE.test(p))) {
      process.stdout.write(JSON.stringify({
        additional_context:
          'Ferrox: .planning/ write detected — ensure STATE.md reflects the latest phase and progress after this change.',
      }));
      return;
    }
