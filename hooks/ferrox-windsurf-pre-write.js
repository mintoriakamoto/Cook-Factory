...
// ferrox-windsurf-pre-write.js — Windsurf/Cascade pre_write_code hook (ADR-1239 / #2100)
//
...
// hooks/ferrox-worktree-path-guard.js — block a write whose file_path resolves
...
function block(reason) {
  process.stderr.write(`Ferrox windsurf pre_write_code guard: ${reason}\n`);
  process.exit(2);
}
