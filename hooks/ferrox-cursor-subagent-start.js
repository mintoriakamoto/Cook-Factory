...
// ferrox-cursor-subagent-start.js — Cursor subagentStart hook (ADR-1239 / #2089)
//
...
//
// Behaviour:
//   - Injects a brief Ferrox state reminder so subagents (planner, executor,
...
const MSG_PRESENT =
  'Ferrox: Subagent session started — review .planning/STATE.md for the current phase and any blockers before acting.';
const MSG_ABSENT =
  'Ferrox: Subagent session started — no .planning/ workflow found.';
