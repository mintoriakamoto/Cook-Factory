...
# ferrox-validate-commit.sh — PreToolUse hook: enforce Conventional Commits format
...
# Uses Node.js for JSON parsing (always available in Ferrox projects, no jq dependency).
#
