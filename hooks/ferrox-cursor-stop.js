...
// ferrox-cursor-stop.js — Cursor stop hook (ADR-1239 / #2089)
//
  ...
  try {
    ...
    if (fs.existsSync(statePath)) {
      process.stdout.write(JSON.stringify({
        additional_context:
          'Ferrox: Agent stopping — run /ferrox:verify-work or /ferrox:progress to confirm the phase goal is met before ending the session.',
      }));
    } else {
      process.stdout.write(JSON.stringify({}));
    }
